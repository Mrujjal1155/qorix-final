...
export const TRANSLATIONS: Record<string, Entry> = {
  ...
  "Install our app": { "pt-BR": "Instale nosso app", es: "Instala nuestra app", hi: "हमारा ऐप इंस्टॉल करें", ur: "ہماری ایپ انسٹال کریں", bn: "আমাদের অ্যাপ ইনস্টল করুন", ar: "ثبّت تطبيقنا" },
  "Add QORIX to your home screen for faster access and one-tap ordering.": { "pt-BR": "Adicione a QORIX à sua tela inicial para acesso mais rápido e pedidos com um toque.", es: "Añade QORIX a tu pantalla de inicio para un acceso más rápido y pedidos con un toque.", hi: "तेज़ एक्सेस और एक-टैप ऑर्डर के लिए QORIX को अपनी होम स्क्रीन पर जोड़ें।", ur: "تیز رسائی اور ایک ٹیپ آرڈر کے لیے QORIX کو اپنی ہوم اسکرین پر شامل کریں۔", bn: "দ্রুত ব্যবহার ও এক ট্যাপে অর্ডারের জন্য QORIX-কে হোম স্ক্রিনে যোগ করুন।", ar: "أضف QORIX إلى شاشتك الرئيسية للوصول الأسرع والطلب بنقرة واحدة." },
  "Not now": { "pt-BR": "Agora não", es: "Ahora no", hi: "अभी नहीं", ur: "ابھی نہیں", bn: "এখন না", ar: "ليس الآن" },
  "iPhone/iPad: open in Safari, tap Share, then \"Add to Home Screen\".": { "pt-BR": "iPhone/iPad: abra no Safari, toque em Compartilhar e depois em \"Adicionar à Tela de Início\".", es: "iPhone/iPad: ábrelo en Safari, toca Compartir y luego \"Añadir a la pantalla de inicio\".", hi: "iPhone/iPad: Safari में खोलें, Share दबाएँ, फिर \"Add to Home Screen\" चुनें।", ur: "iPhone/iPad: Safari میں کھولیں، Share دبائیں، پھر \"Add to Home Screen\" منتخب کریں۔", bn: "iPhone/iPad: Safari-তে খুলে Share চেপে \"Add to Home Screen\" নির্বাচন করুন।", ar: "آيفون/آيباد: افتحه في Safari، اضغط مشاركة ثم \"إضافة إلى الشاشة الرئيسية\"." },
