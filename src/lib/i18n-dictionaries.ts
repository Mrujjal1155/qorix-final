...
export const TRANSLATIONS: Record<string, Entry> = {
  ...
  "Install App": { "pt-BR": "Instalar app", es: "Instalar app", hi: "ऐप इंस्टॉल करें", ur: "ایپ انسٹال کریں", bn: "অ্যাপ ইনস্টল করুন", ar: "تثبيت التطبيق" },
  "How to install": { "pt-BR": "Como instalar", es: "Cómo instalar", hi: "इंस्टॉल कैसे करें", ur: "انسٹال کیسے کریں", bn: "কীভাবে ইনস্টল করবেন", ar: "كيفية التثبيت" },
  "Computer or Android: open this site in Chrome and choose \"Install app\". iPhone/iPad: open in Safari, tap Share, then \"Add to Home Screen\".": { "pt-BR": "Computador ou Android: abra este site no Chrome e escolha \"Instalar app\". iPhone/iPad: abra no Safari, toque em Compartilhar e depois em \"Adicionar à Tela de Início\".", es: "Computadora o Android: abre este sitio en Chrome y elige \"Instalar app\". iPhone/iPad: ábrelo en Safari, toca Compartir y luego \"Añadir a la pantalla de inicio\".", hi: "कंप्यूटर या Android: यह साइट Chrome में खोलें और \"ऐप इंस्टॉल करें\" चुनें। iPhone/iPad: Safari में खोलें, Share दबाएँ, फिर \"Add to Home Screen\" चुनें।", ur: "کمپیوٹر یا Android: یہ سائٹ Chrome میں کھولیں اور \"ایپ انسٹال کریں\" منتخب کریں۔ iPhone/iPad: Safari میں کھولیں، Share دبائیں، پھر \"Add to Home Screen\" منتخب کریں۔", bn: "কম্পিউটার বা Android: এই সাইট Chrome-এ খুলে \"Install app\" নির্বাচন করুন। iPhone/iPad: Safari-তে খুলে Share চেপে \"Add to Home Screen\" নির্বাচন করুন।", ar: "الكمبيوتر أو أندرويد: افتح هذا الموقع في Chrome واختر \"تثبيت التطبيق\". آيفون/آيباد: افتحه في Safari، اضغط مشاركة ثم \"إضافة إلى الشاشة الرئيسية\"." },
